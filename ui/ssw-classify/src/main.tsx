...
import type { ClassifyProcedureOutput, SupportedLanguage, UILanguage } from "@ssw/shared-types";
import {
...
app.ontoolresult = (params) => {
  ...
  if (structured === undefined) {
    renderLocalizedErrorNotice({
      ...
      onRetry: () => {
        void app.updateModelContext({
          content: [{ type: "text", text: "Retry classify_procedure with the same arguments." }],
        });
      },
    });
    return;
