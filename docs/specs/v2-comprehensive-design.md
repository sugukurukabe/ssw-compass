# VCJ Public Design Specification v2 — Comprehensive Research & Sprint 1 Ready Reference

> 監修対象: VISA COMPASS JAPAN (VCJ) — 特定技能ビザ情報を提供する MCP App。Anthropic Connectors Directory + OpenAI Apps SDK 同時公開、6 ホスト対応、Cloud Run (asia-northeast1) 配信。本書は 2026年4月27日時点の一次情報に基づき、Sprint 1 で即実装可能な code/config を提示する。
>
...
_meta: {
  // 標準 MCP Apps
  ui: { resourceUri: "ui://vcj-search/mcp-app.html" },
  // ChatGPT Apps SDK 互換 alias
  "openai/outputTemplate": "ui://vcj-search/mcp-app.html",
...
export function registerSearchVisaTool(server: any) {
  registerAppTool(server, "search_visa", {
    ...
    _meta: {
      ui: {
        resourceUri: "ui://vcj-search/mcp-app.html"
      },
      "openai/outputTemplate": "ui://vcj-search/mcp-app.html",
...
### 6.1 サンプル: `ui/vcj-search/src/main.tsx`
...
import type { SearchVisaOutput } from "@vcj/shared-types";
...
```ts
registerAppResource(server, "vcj-search-ui",
  "ui://vcj-search/mcp-app.html",
  { description: "VCJ search UI" },
  async () => ({ contents: [{
    uri: "ui://vcj-search/mcp-app.html",
    mimeType: "text/html;profile=mcp-app",
    text: await loadHtml("vcj-search"),
    _meta: { ui: {
      prefersBorder: true,
      csp: {
        connectDomains: [],
...
```
vcj-runtime@<project>.iam.gserviceaccount.com
...
export const logger = pino(createGcpLoggingPinoConfig(
  { serviceContext: { service: "vcj-mcp",
    ...
    steps:
      ...
      - uses: google-github-actions/auth@v2
        with:
          ...
          service_account: vcj-deploy@${{ secrets.PROJECT }}.iam.gserviceaccount.com
...
- **詳細 (≤ 25 語):** *"Visa Compass Japan grounds your Japanese SSW visa questions in 出入国在留管理庁 official sources."*
- **Example prompts × 3:**
