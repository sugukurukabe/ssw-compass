...
const ROUTES: Record<string, IndustryRoute> = {
  agriculture: route(
    ["www.maff.go.jp", "asat-nca.jp", MOJ_HOST],
    ["maff", "moj"],
    ["agriculture", "ssw_1"],
  ),
  fishery: route(
    ["www.jfa.maff.go.jp", "suisankai.or.jp", "www.maff.go.jp", MOJ_HOST],
    ["jfa", "maff", "moj"],
    ["fishery", "ssw_1"],
  ),
  food_manufacturing: route(
    ["www.maff.go.jp", "otaff1.jp", MOJ_HOST],
    ["maff", "moj"],
  ...
  manufacturing: route(
    ["www.meti.go.jp", "www.sswm.go.jp", MOJ_HOST],
    ["meti", "moj"],
  ...
  aviation: route(
    ["www.mlit.go.jp", "exam.jaea.or.jp", MOJ_HOST],
    ["mlit", "moj"],
    ["aviation", "ssw_1"],
  ),
  lodging: route(
    ["www.mlit.go.jp", "caipt.or.jp", MOJ_HOST],
    ["mlit", "moj"],
    ["lodging", "ssw_1"],
  ),
  accommodation: route(
  ...
  shipbuilding: route(
    ["www.mlit.go.jp", "www.classnk.or.jp", MOJ_HOST],
    ["mlit", "moj"],
    ["shipbuilding", "ssw_1"],
  ),
  ...
  forestry: route(
    ["www.rinya.maff.go.jp", "www.zenmori.org", MOJ_HOST],
    ["rinya", "maff", "moj"],
    ["forestry", "ssw_1"],
  ),
  wood_products: route(
    ["www.rinya.maff.go.jp", "www.zenmoku.jp", MOJ_HOST],
    ["rinya", "maff", "moj"],
    ["wood_products", "ssw_1"],
  ),
};
