...
describe("vertexSearch — real mode", () => {
  ...
  it("demotes operation guides for a different industry", async () => {
        ...
        [
          {
            document: {
              ...
              derivedStructData: {
                fields: {
                  title: { stringValue: "建設分野 特定技能1号 運用要領" },
                  snippet: { stringValue: "建設分野の基準。" },
                },
              },
              structData: {
                canonicalUrl: "https://www.moj.go.jp/isa/construction-guide.pdf",
                publishedAt: "2026-01-01",
                ministry: "moj",
                tags: ["construction", "ssw_1"],
                dataStoreGroup: "visa_legal_core",
                sourceType: "operation_guide",
              },
            },
          },
          {
            document: {
              ...
              derivedStructData: {
                fields: {
                  title: { stringValue: "鉄道分野 特定技能制度の概要" },
                  snippet: { stringValue: "鉄道分野の概要。" },
                },
              },
              structData: {
                canonicalUrl: "https://www.mlit.go.jp/railway/ssw.html",
                publishedAt: "2026-01-02",
                ministry: "mlit",
                tags: ["railway", "ssw_1"],
                dataStoreGroup: "visa_legal_core",
    ...
    expect(result.chunks.map((chunk) => chunk.docId)).toEqual([
      "railway-overview",
      "construction-guide",
    ]);
  });
